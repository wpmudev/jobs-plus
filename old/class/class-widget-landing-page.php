...
class WP_Widget_Landing_Page extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'widget_landing_page', 'description' => __( "Landing Page" ) );
		parent::__construct( 'landing-page', __( 'Jobs + Landing Page' ), $widget_ops );
	...
	function widget( $args, $instance ) {
		...
		if ( ! $core->can_view( $instance['view'] ) ) return '';
		...
		<div class="jbp_landing_page_widget">
			<?php the_widget( 'WP_Widget_Recent_Jobs', array(
			'title'            => $job_title,
			'number'           => $number,
			'show_browse_link' => 1,
			'show_cat'         => $show_cat,
			...
			<br />
			<?php the_widget( 'WP_Widget_Recent_Pros', array(
	...
	function form( $instance ) {
		...
		<fieldset>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'job_title' ) ); ?>"><?php esc_html_e( 'Job Widget Title:', JBP_TEXT_DOMAIN ); ?></label>
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'job_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'job_title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'job_number' ) ); ?>"><?php esc_html_e( 'Number of job posts to show:', JBP_TEXT_DOMAIN); ?></label>
				<input id="<?php echo esc_attr( $this->get_field_id( 'job_number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'job_number' ) ); ?>" type="text" value="<?php echo $number; ?>" size="3" />
			</p>

			<p>
				<input class="checkbox" type="checkbox" <?php checked( $show_cat ); ?> id="<?php echo esc_attr( $this->get_field_id( 'job_show_cat' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'job_show_cat' ) ); ?>" />
				<label for="<?php echo esc_attr( $this->get_field_id( 'job_show_cat' ) ); ?>"><?php esc_html_e( 'Display job categories?', JBP_TEXT_DOMAIN ); ?></label>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'job_order_by' ) ); ?>"><?php esc_html_e( 'Order by', JBP_TEXT_DOMAIN ); ?>:</label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'job_order_by' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'job_order_by' ) ); ?>">
		...
		<fieldset>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'expert_title' ) ); ?>"><?php esc_html_e( 'Expert Widget Title:', JBP_TEXT_DOMAIN ); ?></label>
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'expert_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'expert_title' ) ); ?>" type="text" value="<esc_attr( ?php echo esc_attr( $expert_title ); ?>" />
				</p>

				)	<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'expert_number' ) ); ?>"><?php esc_html_e( 'Number of experts to show:', JBP_TEXT_DOMAIN ); ?></label>
					<input id="<?php echo esc_attr( $this->get_field_id( 'expert_number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'expert_number' ) ); ?>" type="text" value="<?php echo esc_attr( $expert_number ); ?>" size="3" />
				</p>

				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'line_count' ) ); ?>"><?php esc_html_e( 'Number of expert per line:', JBP_TEXT_DOMAIN ); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'expert_order_by' ) ); ?>"><?php esc_html_e( 'Order by', JBP_TEXT_DOMAIN ); ?>:</label>
					<select id="<?php echo esc_attr( $this->get_field_id( 'expert_order_by' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'expert_order_by' ) ); ?>">
						<option <?php selected( 'randomize', $expert_order_by ) ?> value="randomize"><?php esc_html_e('Randomize', JBP_TEXT_DOMAIN );?></option>
						<option <?php selected( 'latest', $expert_order_by ) ?> value="latest"><?php esc_html_e('Latest', JBP_TEXT_DOMAIN );?></option>
					</select>
				</p>
			</fieldset>
			<p>
				...
				<select name="<?php echo esc_attr( $this->get_field_name( 'view' ) ); ?>">
					<option <?php echo selected( 'both', $view ) ?> value="both"><?php esc_attr_e( 'Both', JBP_TEXT_DOMAIN ) ?></option>
					<option <?php echo selected( 'loggedin', $view ) ?> value="loggedin"><?php esc_attr_e( 'Signed in', JBP_TEXT_DOMAIN ) ?></option>
					<option <?php echo selected( 'loggedout', $view ) ?> value="loggedout"><?php esc_attr_e( 'Not sign in', 'domain', JBP_TEXT_DOMAIN ) ?></option>
				</select>
			</p>
			<?php
		}
