...
<div id="post-jbp-pro">
	<h3><?php the_title(); _e(' &raquo; Contact', JBP_TEXT_DOMAIN); ?></h3>
	<form action="#"  method="post" id="jbp-pro-contact">
		...
		<input type="hidden" name="subject" value="<?php the_title(); _e(' &raquo; Contact', JBP_TEXT_DOMAIN); ?>" />
		...
		<div class="jobs-nav">
			...
			<button class="jbp-button" type="submit" name="jbp-pro-contact" value="1"><?php _e( 'Send', JBP_TEXT_DOMAIN ); ?></button>
