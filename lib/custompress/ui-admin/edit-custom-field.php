							...
							<div class="ct-field-type-options">
								...
								<p>
									...
									<select name="field_sort_order">
										<option value="default"><?php esc_html_e('Order Entered', $this->text_domain); ?></option>
										<?php /** @todo introduce the additional order options
										<option value="asc"><?php esc_html_e('Name - Ascending', $this->text_domain); ?></option>
										<option value="desc"><?php esc_html_e('Name - Descending', $this->text_domain); ?></option>
										*/ ?>
									</select>
								</p>
					...
					<tr>
						...
						<td>
							<select name="hide_type[]" multiple="multiple" class="ct-object-type">
								<?php if ( !empty( $post_types ) ): ?>
								<?php foreach( $post_types as $post_type ): ?>
								<option value="<?php echo esc_attr( $post_type ); ?>" <?php if(is_array( $custom_field['hide_type'] ) ) { foreach ( $custom_field['hide_type'] as $key => $hide_type ) { if ( $hide_type == $post_type ) echo( 'selected="selected"' ); } } ?>><?php echo esc_html( $post_type ); ?></option>
								<?php endforeach; ?>
								<?php endif; ?>
							</select>
							<br />
