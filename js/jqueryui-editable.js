    ...
    Editable.prototype = {
        ...
        */
        render: function(response) {
            ...
            if(this.input.value2htmlFinal) {
            	//this.isEmpty = this.options.disabled;
              var obj = this.input.value2html(this.value, this.$element[0], this.options.display, response);
              //this.isEmpty = false;
              return obj;
        ...
        */
        handleEmpty: function (isEmpty) {
            ...
            */
// 						//If something in the element then force check for emptiness
//            var blank = $.trim(this.$element.html()) === ''; // NO text in element
//            isEmpty = blank ? isEmpty : false;
//            console.log(isEmpty);
            if(isEmpty !== undefined) {
                this.isEmpty = isEmpty;
            } else {
//            	console.log('x'+this.isEmpty);
                //detect empty
