...
<div class="wrap">
	...
	<form action="#" method="post">
			...
			<div class="inside">
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<input class="jbp-full" type="text" id="email_subject" name="jbp[job][email_subject]" value="<?php esc_attr_e( $this->get_setting( 'job->email_subject' ) ); ?>" />
							<br />
		...
		<p class="submit">
			...
			<input type="submit" class="button-primary" name="job-settings" value="<?php esc_attr_e('Save Changes', JBP_TEXT_DOMAIN);?>">
		</p>
	</form>
</div>
