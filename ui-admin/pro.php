			...
			<table class="form-table">
				<tr>
					...
					<td>
						...
						<br /><span class="description"><?php echo sprintf(__('Select a role to which you want to assign %s capabilities.', $this->text_domain), $this->pro_obj->capability_type ); ?></span>
						<br /><br />
						<div id="capabilities">
							<?php
