...
-->
				...
				<div class="jbp_plans">
					<div class="jbp_plan">
						...
						<p>
							<a href="<?php echo admin_url( 'post-new.php?post_type=jbp_job' ) ?>"><?php _e( 'Add', je()->domain ) ?></a> <?php echo esc_html( sprintf( __( 'a new %s', je()->domain ), $job_labels->singular_name ) ); ?>
						</p>

						<p>
							<?php echo esc_html( sprintf( __( '%s', je()->domain ), $job_labels->name ) ); ?> <a
								href="<?php echo admin_url( 'edit.php?post_type=jbp_job&page=jobs-plus-menu&tab=job' ) ?>"><?php _e( 'Settings', je()->domain ) ?></a>
						</p>
					</div>
					<div class="jbp_plan">
						<p class="first">
					...
					<div class="jbp_plan">
						...
						<p>
							<?php echo esc_html( sprintf( __( '%s', je()->domain ), $pro_labels->name ) ); ?> <a
								href="<?php echo admin_url( 'edit.php?post_type=jbp_job&page=jobs-plus-menu&tab=expert' ) ?>"><?php _e( 'Settings', je()->domain ) ?></a>
						</p>
					</div>
				</div>
			</div>
