        ...
        if (isset($_POST['type'])) {
            ...
            switch ($_POST['type']) {
                case 'add_new_job':
                    ...
                    break;
                case 'edit_job':
                    $vid = $page_module->page($page_module::JOB_EDIT);
                    $vpage = get_post($vid);
                    //reset the post data
                    $page = $this->reset_page($vpage)->to_array();
                    //insert page
                    ...
                    break;
                case 'contact_job':
                    $vid = $page_module->page($page_module::JOB_CONTACT);
                    $vpage = get_post($vid);
                    //reset the post data
                    $page = $this->reset_page($vpage)->to_array();
                    //insert page
                    ...
                    break;
                case 'list_jobs':
                    $vid = $page_module->page($page_module::JOB_LISTING);
                    $vpage = get_post($vid);
                    //reset the post data
                    $page = $this->reset_page($vpage)->to_array();
                    //insert page
                    ...
                    break;
                case 'my_jobs':
                    $vid = $page_module->page($page_module::MY_JOB);
                    $vpage = get_post($vid);
                    //reset the post data
                    $page = $this->reset_page($vpage)->to_array();
                    //insert page
                    ...
                    break;
                case 'add_new_expert':
                    $vid = $page_module->page($page_module::EXPERT_ADD);
                    $vpage = get_post($vid);
                    //reset the post data
                    $page = $this->reset_page($vpage)->to_array();
                    //insert page
                    ...
                    break;
                case 'edit_expert':
                    $vid = $page_module->page($page_module::EXPERT_EDIT);
                    $vpage = get_post($vid);
                    //reset the post data
                    $page = $this->reset_page($vpage)->to_array();
                    //insert page
                    ...
                    break;
                case 'contact_expert':
                    $vid = $page_module->page($page_module::EXPERT_CONTACT);
                    $vpage = get_post($vid);
                    //reset the post data
                    $page = $this->reset_page($vpage)->to_array();
                    //insert page
                    ...
                    break;
                case 'list_experts':
                    $vid = $page_module->page($page_module::EXPERT_LISTING);
                    $vpage = get_post($vid);
                    //reset the post data
                    $page = $this->reset_page($vpage)->to_array();
                    //insert page
                    ...
                    break;
                case 'my_profiles':
                    $vid = $page_module->page($page_module::MY_EXPERT);
                    $vpage = get_post($vid);
                    //reset the post data
                    $page = $this->reset_page($vpage)->to_array();
                    //insert page
                ...
                jQuery(document).ready(function ($) {
                    $('body').on('click', '.create-page', function () {
                        ...
                        $.ajax({
                            ...
                            beforeSend: function () {
                                that.attr('disabled', 'disabled').text('<?php _e('Creating...',JBP_TEXT_DOMAIN) ?>');
                            },
                            success: function (data) {
                                $('#page-creator').load("<?php echo "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" ?> #page-creator", function (html) {
                                    that.removeAttr('disabled').text('<?php _e('Create Page',JBP_TEXT_DOMAIN) ?>');
                                });
                            }
                        })
                    })
