+function ($) {
    ...
    var old = $.fn.tooltipext

    $.fn.tooltipext = Plugin
    $.fn.tooltipext.Constructor = Tooltip


    // TOOLTIP NO CONFLICT
    // ===================

    $.fn.tooltipext.noConflict = function () {
        $.fn.tooltipext = old
        return this
    }
...
+function ($) {
    ...
    PopoverAsync.DEFAULTS = $.extend({}, $.fn.tooltipext.Constructor.DEFAULTS, {
        placement: 'right',
        trigger: 'click',
        content: '',
    ...
    PopoverAsync.prototype = $.extend({}, $.fn.tooltipext.Constructor.prototype)
