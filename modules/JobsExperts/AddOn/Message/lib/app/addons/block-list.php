...
if ( ! class_exists( 'MM_Block_List' ) ) {
	class MM_Block_List extends IG_Request {
		...
		function all_users() {
			if ( ! wp_verify_nonce( FRequest::get( '_wpnonce' ), 'mm_all_users' ) ) {
				exit;
			}
		...
		function append_form() {
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					...
					<input id="mm-block-list-input" name="mm_user_block" type="text" class="form-control" value="<?php echo $block_list ?>"/>
				</div>
