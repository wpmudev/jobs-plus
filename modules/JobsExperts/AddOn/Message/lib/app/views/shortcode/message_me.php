...
<div class="mmessage-container">
    <div id="<?php echo $cid ?>">
        <button type="button" id="<?php echo $bid ?>"
                class="<?php echo $a['class'] ?>"><?php echo $a['text'] ?></button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php $form->open(array("attributes" => array("class" => "form-horizontal", "id" => $fid))); ?>
                        <?php if ($a['subject']): ?>
                        ...
                        <div class="form-group <?php echo $model->has_error("content") ? "has-error" : null ?>">
                            <div class="col-lg-12">
                                <?php $form->text_area("content", array("attributes" => array("class" => "form-control mm_wsysiwyg", "id" => "content_" . $cid, "style" => "height:100px"))) ?>
                                <span
                        ...
                        <?php $form->close(); ?>
                        <?php ig_uploader()->show_upload_control($model, 'attachment', $fid) ?>
                    </div>
