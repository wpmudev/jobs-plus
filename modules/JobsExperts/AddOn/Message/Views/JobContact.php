 ...
 * Author: Hoang Ngo
 */
class JobsExperts_AddOn_Message_Views_JobContact extends JobsExperts_Framework_Render
{
                    ...
                    <div class="jobs-contact">
                        ...
                        <?php else: ?>
                            <form method="post" class="form-horizontal jobs-contact-form" role="form">
                                <?php do_action('jbp_before_job_contact_form', $form) ?>
                                ...
                                <div class="form-group has-feedback">
                                    <label
                                        class="col-sm-3 control-label"><?php _e('Content:', JBP_TEXT_DOMAIN) ?></label>
                                ...
                                <?php do_action('jbp_middle_job_contact_form', $form) ?>
                                ...
                                <?php do_action('jbp_after_job_contact_form', $form) ?>
