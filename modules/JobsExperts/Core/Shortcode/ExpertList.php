				...
				<form method="get" action="<?php echo get_post_type_archive_link( 'jbp_pro' ); ?>">
					...
					<div class="jbp_sort_search row">
						<div class="jbp_search_form">
							<input type="text" class="pro-search" name="s" value="<?php echo esc_attr( $search ) ?>" autocomplete="off" placeholder="<?php echo __( sprintf( 'Search For %s', $plugin->get_expert_type()->labels->name ), JBP_TEXT_DOMAIN ) ?>" />
										...
										<div class="jbp_inside">
											<div class="meta_holder">
												...
												<div class="jbp_pro_meta hide hidden-sx hidden-sm">
													<p><?php esc_html_e( jbp_shorten_text( $text, 100 / $col['text_length'] ) ) ?></p>
