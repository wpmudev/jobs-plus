...
class JobsExperts_Core_Views_Settings_General extends JobsExperts_Framework_Render
{
    ...
    public function _to_html()
    {
        ...
        $components = new JobsExperts_Core_Table_ComponentTable();
        ?>
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    ...
                    <br/><span
                        class="description"><?php esc_html_e('Sets the default color of the button icons. May be overriden for individual buttons in the "class" attribute of the shortcode.', JBP_TEXT_DOMAIN); ?></span>
                </td>
            </tr>
        </table>
        <div class="page-header">
            <h3 class="hndle"><span><?php esc_html_e('Components', JBP_TEXT_DOMAIN) ?></span></h3>
        </div>
        <div class="">
