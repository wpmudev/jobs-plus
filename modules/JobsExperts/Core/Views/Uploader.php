        ...
        <table class="table table-bordered job-files">
            ...
            if (empty($portfolios)) {
                ...
                foreach ($portfolios as $porfolio) {
                    ...
                    ?>
                    <tr data-id="<?php echo $porfolio ?>" data-link="<?php echo esc_attr($link) ?>"
                ...
                if (next.hasClass('popover')) {
                    ...
                    form.find('input[type="file"]').on('change', function (e) {
                        ...
                        if (file.size > max_file_upload) {
                            alert('<?php echo esc_js(__('Your file is too large!',JBP_TEXT_DOMAIN)) ?>');
                            $(this).val("");
                        }
                        //check type
                        var type = file.type;
                        if (type != undefined && type.length > 0) {
                            ...
                            if ($.inArray(type, allowed) == -1) {
                                alert('<?php echo esc_js(__('Your file type is not supported!',JBP_TEXT_DOMAIN)) ?>');
                                $(this).val("");
                            }
                        }
                    });
                        ...
                        if (form.validationEngine('validate')) {
                            ...
                            args.success = function (data) {
                                ...
                                if (result.status == 'success') {
                                    ...
                                    actions.append($('<button/>').addClass('btn btn-info btn-xs edit-file').html('<i class="glyphicon glyphicon-pencil"></i>').attr({
        ...
        <form method="post" class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="file" name="p_images" style="max-width: 300px"
                           class="p_images validate[groupRequired[file]]" id="p_images">
                    <?php if ($is_edit == true): ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="text" value="" style="max-width: 300px"
                           class="validate[groupRequired[file],custom[url]]" name="portfolio_link">
                </div>
                <div class="clearfix"></div>
            </div>
            <div class="row">
