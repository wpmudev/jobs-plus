		...
		<div class="wrap jbp_started_page">
			...
			<div style="display: inline-table; width: 20%">
				...
				<div class="jbp_plans">
					<div class="jbp_plan">
						<p class="first">
							<a href="<?php echo get_post_type_archive_link( 'jbp_job' ) ?>" target="jobs" class="jbp_button jbp_job_pages"><?php echo esc_html( sprintf( __( '%s Listings', JBP_TEXT_DOMAIN ), $job_labels->name ) ); ?></a>
						</p>
					...
					<div class="jbp_plan">
						<p class="first">
							<a href="<?php echo get_permalink( $page_module->page( $page_module::LANDING_PAGE ) ) ?>" target="landing" class="jbp_button jbp_landing_page"><?php esc_html_e( 'Jobs & Experts Overview', JBP_TEXT_DOMAIN ); ?></a>
						</p>
					...
					<div class="jbp_plan">
						<p class="first">
							<a href="<?php echo get_post_type_archive_link( 'jbp_pro' ) ?>" target="pros" class="jbp_button jbp_experts_pages"><?php echo esc_html( sprintf( __( '%s Listings', JBP_TEXT_DOMAIN ), $pro_labels->name ) ); ?></a>
						</p>
