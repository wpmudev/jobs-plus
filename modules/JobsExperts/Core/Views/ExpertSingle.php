		...
		<div class="col-md-7 col-xs-12 col-sm-12" style="padding: 0">
			...
			<div class="pro-single-content">
				...
				if ( ! empty( $model->company ) ): ?>
					<div class="row">
						<div class="col-md-12 col-xs-12 col-sm-12">
							<p>
								<label><?php _e( 'Company:', JBP_TEXT_DOMAIN ) ?></label> &nbsp;<a href="<?php echo $model->company_url ?>"><?php echo $model->company ?></a>
							</p>
						</div>
				...
				<div class="row jbp-pro-stat hidden-xs hidden-sm">
					<div class="col-md-3">
						<span><?php echo $model->get_view_count() ?></span>&nbsp;<i class="glyphicon glyphicon glyphicon-eye-open"></i>
						<small><?php _e( 'Views', JBP_TEXT_DOMAIN ) ?></small>
					</div>
					<div class="col-md-3">
						<span class="like-count"><?php echo $model->get_like_count() ?></span><i class="glyphicon glyphicon glyphicon-heart"></i>
						<small><?php _e( 'Likes', JBP_TEXT_DOMAIN ) ?></small>
					</div>
					<div class="col-md-3">
						<?php $disabled = $model->is_current_user_can_like() ? null : 'disabled="disabled"' ?>
						<button <?php echo $disabled ?> type="button" class="btn btn-danger jbp-pro-like"><?php _e( 'Like', JBP_TEXT_DOMAIN ) ?></button>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="row full">
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														<h4 class="modal-title" id="myModalLabel">Sample Information</h4>
													</div>
