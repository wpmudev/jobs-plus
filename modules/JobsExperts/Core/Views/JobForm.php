                ...
                $("#jbp_job_form").find('.submit').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.status == 1) {
                                var n = noty({
                                    text: '<?php echo esc_js(__('Job '.($is_edit==true?'updated':'posted').' successful, redirecting...',JBP_TEXT_DOMAIN)) ?>',
                                    layout: 'center',
                                    type: 'success',
                                    timeout: 5000
                                });
                                ...
                                //display noty
                                var n = noty({
                                    text: '<?php echo esc_js(__('Error, please check the form data.',JBP_TEXT_DOMAIN) )?>',
                                    layout: 'center',
                                    type: 'error',
                                    timeout: 5000
                                });
