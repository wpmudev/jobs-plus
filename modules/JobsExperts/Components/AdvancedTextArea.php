 ...
 * Description: Use WYSIWYG for jobs/experts detail field, the value will be filter by kses for security
 * Author: Hoang Ngo
 */
class JobsExpert_Compnents_AdvancedTextArea extends JobsExperts_Components
{
